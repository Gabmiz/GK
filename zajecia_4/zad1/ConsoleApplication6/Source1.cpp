...
void GenerateTextures()
{
	...
	// wczytanie tekstury blonde_girl_white_skin_6_20141210_2078688115.tga
	GLboolean error = load_targa("blonde_girl_white_skin_6_20141210_2078688115.tga", width, height, format, type, pixels);

	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku blonde_girl_white_skin_6_20141210_2078688115.tga");
		exit(0);
	}
	...
	error = load_targa("blonde_girl_white_skin_6_20141210_2078688115.tga", width, height, format, type, pixels);
...
int main(int argc, char *argv[])
{
	...
	glutAddMenuEntry("blonde_girl_white_skin_6_20141210_2078688115.tga (kompresja)", TEXTURE_LENA);
	glutAddMenuEntry("blonde_girl_white_skin_6_20141210_2078688115.tga (bez kompresji)", TEXTURE_LENA_UNC);
