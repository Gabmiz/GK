...
void GenerateTextures()
{
	...
	// wczytanie tekstury shrub_medium_size_20160420_1220353503.tga
	error = load_targa("shrub_medium_size_20160420_1220353503.tga", width, height, format, type, pixels);

	// błąd odczytu pliku
	if (error == GL_FALSE)
	{
		printf("Niepoprawny odczyt pliku shrub_medium_size_20160420_1220353503.tga");
		exit(0);
	}
